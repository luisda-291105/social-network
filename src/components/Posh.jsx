    ...
    const posh_nuevos = [
        {
            ...
            descripcion:
                "Camiseta oversize color negro, estilo urbano moderno.",
        },
        {
            id: 2,
            imagen: "https://picsum.photos/300?random=2",
            descripcion: "Pantalón cargo beige con múltiples bolsillos.",
        },
        {
            id: 3,
            imagen: "https://picsum.photos/300?random=3",
            descripcion: "Chaqueta denim clásica azul, corte regular.",
        },
        {
            id: 4,
            imagen: "https://picsum.photos/300?random=4",
            descripcion: "Hoodie gris con estampado minimalista.",
        },
        {
            id: 5,
            imagen: "https://picsum.photos/300?random=5",
            descripcion: "Tenis blancos casuales para uso diario.",
        },
        {
            id: 6,
            imagen: "https://picsum.photos/300?random=6",
            descripcion: "Gorra negra ajustable estilo streetwear.",
        },
        {
            id: 7,
            imagen: "https://picsum.photos/300?random=7",
            descripcion: "Camisa manga corta con estampado tropical.",
        },
        {
            id: 8,
            imagen: "https://picsum.photos/300?random=8",
            descripcion: "Short deportivo ligero color azul oscuro.",
        },
        {
            id: 9,
            imagen: "https://picsum.photos/300?random=9",
            descripcion: "Suéter tejido color crema, estilo elegante.",
        },
        {
            id: 10,
            imagen: "https://picsum.photos/300?random=10",
            descripcion: "Chaqueta bomber negra con cierre frontal.",
        },
        {
            id: 11,
            imagen: "https://imgs.search.brave.com/Iw6FYICfb9udkU08V5lzNPi6gJK81zZlMIs5_68ZyS0/rs:fit:500:0:1:0/g:ce/aHR0cHM6Ly93YWxs/cGFwZXJzLmNvbS9p/bWFnZXMvaGQvY29v/bGVzdC1uYXJ1dG8t/d2l0aC1nbG93aW5n/LWxpZ2h0LXRpeWJq/eDN1MjdtMGo0MXQu/anBn",
            descripcion: "hola bb ",
        },
    ];
        ...
        <>
            <div className="w-full h-auto ">
                {posh_nuevos.map((p) => (
                    <div
                        key={p.id}
                        className="card mx-2 my-4 w-auto"
                    ...
                    >
                        ...
                        {btnComment && (
                            <ComentForm getCommenData={getCommenData} />
                        )}
